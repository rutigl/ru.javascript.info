...
*Остаточные параметры* могут быть обозначены через три точки `...`. Буквально это значит: "Cобери оставшиеся параметры и положи их в массив".
...
Все аргументы функции находятся в псевдомассиве `arguments` под своеми порядковыми номерами.
...
Но иногда нужно сделать прямо противоположное.
